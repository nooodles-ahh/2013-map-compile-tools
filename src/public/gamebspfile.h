...
enum
{
	...
	GAMELUMP_WORLD_LIGHTS = GAMELUMP_MAKE_CODE( 'w', 'l', 'd', 'l' ),
	GAMELUMP_WORLD_LIGHTS_HDR = GAMELUMP_MAKE_CODE( 'w', 'l', 'd', 'h' ),
};
...
enum
{
	...
	GAMELUMP_WORLD_LIGHTS_VERSION = 0,
	GAMELUMP_WORLD_LIGHTS_HDR_VERSION = 0,
};
